 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DataIds implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DataIds';
    ...
    {
        $this->container['dataIds'] = isset($data['dataIds']) ? $data['dataIds'] : null;
    }
    ...
    {
        return $this->container['dataIds'];
    }

    /**
     * Sets dataIds
     *
     * @param int[] $dataIds dataIds
     *
     * @return $this
     */
    public function setDataIds($dataIds)
    {
        $this->container['dataIds'] = $dataIds;
